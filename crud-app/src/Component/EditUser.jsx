    ...
    return (
        <Container injectFirst>
            ...
            <FormControl>
                ...
                <Input onChange={(e) => onValueChange(e)} name='emp_name' value={emp_name} id="my-input" aria-describedby="my-helper-text" />
            </FormControl>
            <FormControl>
                <InputLabel htmlFor="my-input">Employee Designation</InputLabel>
                <Input onChange={(e) => onValueChange(e)} name='emp_desi' value={emp_desi} id="my-input" aria-describedby="my-helper-text" />
            </FormControl>
            <FormControl>
